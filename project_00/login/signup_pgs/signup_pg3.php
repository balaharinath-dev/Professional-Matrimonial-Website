                    ...
                    <form>
                        <div class="row m-0 mt-3">
                            ...
                            <div class="col-6 p-0 px-2 mb-3 d-flex justify-content-start align-items-end" style="flex-grow: 1;">
                                <a href="signup_pg2.php" target="_self" role="button" class="btn mybtn d-lg-block d-none prev3" value="prev3">Previous</a>
                                <a href="signup_pg2.php" target="_self" role="button" class="btn btn-sm mybtn d-lg-none d-block prev3" value="prev3">Previous</a>
                            </div>                          
