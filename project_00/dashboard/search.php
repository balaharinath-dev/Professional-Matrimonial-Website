                ...
                <div class="offcanvas offcanvas-start s-canvas" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                    ...
                    <div class="offcanvas-body pt-0">                        
                        ...
                        <div class="list-group">
                            ...
                            <a href="search.php" class="list-group-item list-group-item-action active">Search</a>                          
                        </div>
                        <hr class="my-3 mx-0">
                        <div class="list-group">
                                ...
                                <div class="row m-0">
                                    <div class="col-lg-4 col-sm-6 p-0 px-2 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="filterid" name="filterid" placeholder="If ID is used other filters doesn't work" value="">                                                
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 p-0 px-2 mb-3">
                                        <div class="form-group">
